...
This document serves as the high-level operational "Command Center" for the expedition. It details the critical path, daily drive rhythms, and key deadlines.
...
*   **Jerry Cans**: Fill **ALL** cans (40L+) at **Hotel Barbas** (Morocco) before entering Mauritania. Fuel in Mauritania is dirty/expensive.
*   **Cash**:
    *   **Euros**: King. Keep small notes (€5, €10, €20) for borders/fees.
    *   **Dirham (MAD)**: Closed currency. Spend or exchange before exiting Morocco.
    *   **CFA (XOF)**: Used in Senegal. Get some at the border or Diama.
    *   **Dalasi (GMD)**: Gambia. Cash economy.
*   **Convoy Comms**: Radios (TIDRADIO) on Channel 1 (or agreed frequency). Check in every hour.
